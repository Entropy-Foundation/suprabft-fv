...
date
ivy_check trace=true isolate=basic_safety.blockchain_safety_lemma2 classic_safety.ivy
date
...
date
ivy_check trace=true macro_finder=false isolate=basic_safety.gdc_chain_lemma7 classic_safety.ivy
date
ivy_check trace=true isolate=basic_safety.gdc_chain_lemma8 classic_safety.ivy
date
ivy_check trace=true macro_finder=false isolate=basic_safety.gdc_chain_lemma9 classic_safety.ivy
date
...
date
ivy_check trace=true isolate=quorum_propogation classic_safety.ivy
date
ivy_check trace=true isolate=quorum_propogationm1 classic_safety.ivy
date
ivy_check trace=true isolate=quorum_propogationm2 classic_safety.ivy
date
